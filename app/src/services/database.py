...
DB_BASE_DIR = os.environ.get('SERVICES_DB_DIR', BASE_DIR)

DB_PATHS = {
    "atributos": os.path.join(DB_BASE_DIR, "atributos.db"),
    "empleados": os.path.join(DB_BASE_DIR, "empleados.db"),
    "misc": os.path.join(DB_BASE_DIR, "misc.db"),
    "stock": os.path.join(DB_BASE_DIR, "stock.db"),
    "store_data": os.path.join(DB_BASE_DIR, "store_data.db"),
    "grupos_cumplimiento": os.path.join(DB_BASE_DIR, "grupos_cumplimiento.db"),
    "secuencias_numericas": os.path.join(DB_BASE_DIR, "secuencias_numericas.db"),
    "tipos_entrega": os.path.join(DB_BASE_DIR, "tipos_entrega.db"),
    "config_impositiva": os.path.join(DB_BASE_DIR, "config_impositiva.db"),
    "payments": os.path.join(DB_BASE_DIR, "payments.db"),
}
