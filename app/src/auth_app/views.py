...
from services.caching import obtener_empleado_by_email_from_parquet
...
def login_view(request):
    ...
    if request.method == "POST":
        try:
            ...
            datos = obtener_empleado_by_email_from_parquet(mail) or {}
            if not datos:
                messages.error(request, "No se encontraron datos del empleado en el cache parquet.")
                return render(request, "login.html")
